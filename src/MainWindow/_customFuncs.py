...
def addCustomFuncs(self):
    ...
    self._addCustomFunc('Solve as an Implicit Derivative', 'out = idiff(eq=expr, y=y, x=x, n=1)', 'eq is the equation. Must equal 0 (use -, not Eq() or =)', 'n is the order of the derivative')
    # self._addCustomFunc('', '')
