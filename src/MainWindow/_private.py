...
def resetTheSolutionUnit(self):
    self.solutionUnitBox.setCurrentIndex(self.allUnits[self.solutionUnitBox.currentIndex()])
    self.updateEquation()
...
def calculateSolution(self):
    ...
    unit = self.allUnits[self.solutionUnitBox.currentIndex()]
...
# def getAvailableUnits(self, system=None):
#     return allUnits
    # if system is None:
    #     system = self.unitSystem
    # if system == 'Dimentionless':
    #     return [1]
    # elif system == 'Physics':
    #     return [1, ]
    # elif system == 'Astrophysics':
    #     return [1, ]
    # elif system == 'Electronics':
    #     return [1, ]
